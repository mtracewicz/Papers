...
Informacje w tym rozdziale powstały na podstawie książki ``Hands-On Machine Learning with Scikit-Learn and TensorFlow''\cite{handsonmachinelearning}
...
\begin{align}
    O(x)=\sigma(\sum\limits_{i=0}^{n}{w_i x_i}+\theta)
\end{align}
gdzie:
\begin{itemize}
    \item $\sigma$ - funkcja skokowa np. funkcja znaku
