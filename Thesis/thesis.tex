...
Rozwiązanie zostało napisane w języku Python z użyciem następujących bibliotek
\begin{itemize}
  \item Keras - służy do pracy z sieciami neuronowymi i jest interfejsem do biblioteki TensorFlow
  \item TensorFlow - biblioteka ta pozwala na wykonywanie obliczeń na tensorach
  \item NumPy - biblioteka do obliczeń numerycznych na n-wymiarowych tablicach
  \item Pillow - biblioteka pozwalająca na wczytywanie, zapisywanie oraz edycję obrazów.
  \item Jupyter Notebook - pozwalająca utworzyć interaktywne środowisko uruchomieniowe Python-a w przeglądarce.
\end{itemize}
...
Z tego powodu przetestowałem również możliwość uruchomienia splotowej sieci neuronowej w przeglądarce z użyciem biblioteki TensorFlowJS.
