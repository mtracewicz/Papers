...
\begin{lstlisting}[caption=Kod workera,language=JavaScript]
...
\end{itemize}
\begin{lstlisting}[caption=Fragment skrytu dzielącego obrazy na mniejsze]
...
\begin{lstlisting}[caption={Dynamiczne wczytywanie funkcji oraz stałych z innych skryptów}]
